  ...
  <div id="export-modal">
    ...
    <div class="body">
      <div class="body-block">
        <div class="block-title">Select data</div>
        <div class="check-box-block">
          <check-box-item
            ...
            :data_obj="{
              name: key,
              isChecked: value,
              category_name: 'data_categories',
            }"
          />
        </div>
      </div>
      <div class="body-block">
        <div class="block-title">Select format</div>
        <div class="check-box-block">
          <check-box-item
...
export default {
  ...
  computed: {
    isExportButtonDisabled() {
      return !(
        Object.values(this.data_categories).some(
    ...
    async export_data() {
      ...
      try {
        const response = await this.$axios.post(
          "https://94gzkk.deta.dev/account/export_data",
          data,
          {
