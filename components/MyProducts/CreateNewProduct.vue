  ...
  <div id="create-new-product">
    ...
    <div class="content width-full">
      <div class="product-name-input width-full">
        <div class="name-label label width-full">Product name</div>
      ...
      <div class="category-select width-full">
        ...
        <custom-select :product="product"> </custom-select>
      </div>
    </div>
    <div class="buttons">
  ...
  computed: {
    ...
    input_error_styles() {
      if (this.product_name.length === 0) {
        ...
        return {
          "--content": JSON.stringify("Please enter product name"),
          "--border-color": "#FF5252",
          "--back-color": "#696AE9",
          "--cursor": "default",
          "--opacity": "0.5",
      ...
      let categories_products = Array.from(
        this.$store.state.state.existing_categories[0].products
