<template>
  <div class="product-item">
    ...
    <div class="name-category">
      ...
      <div
        class="product-name long"
        v-if="product_name.length >= 20"
        :style="{ '--content': JSON.stringify(product_name) }"
      >
    ...
    <div class="buttons">
      <blue-stroke-button class="edit-button" @click.native="edit">
        <div class="btn-text" v-if="windowWidth > 860">Edit</div>
        <div class="btn-text" v-if="windowWidth <= 860"></div>
