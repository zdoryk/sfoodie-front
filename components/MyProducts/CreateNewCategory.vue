  ...
  <div id="create-new-category">
    ...
    <div class="content width-full">
      <div class="category-name-input width-full">
        <div class="name-label label width-full">Name of category</div>
        <div class="error" :style="input_error_styles">
          <input
            class="width-full email-input"
            type="text"
      ...
      <div class="icon-select width-full">
        <div class="color-label label width-full">Select Icon</div>
        <div class="icons">
          <button-icon
  ...
  computed: {
    ...
    input_error_styles() {
      if (this.category_name.length === 0) {
        ...
        return {
          "--content": JSON.stringify("Please enter category name"),
          "--border-color": "#FF5252",
          "--back-color": "#696AE9",
          "--cursor": "default",
          "--opacity": "0.5",
      ...
      let categories_names = Array.from(
        this.$store.state.state.existing_categories
      );
      categories_names = categories_names.map((category) =>
