<template>
  <div id="password-recovery-modal">
    <div id="code-modal" v-if="!is_password_updated">
      <div class="recovery-title">Password recovery</div>
      <div class="content-code">
        ...
        <div>
          ...
          <div
            class="error"
            :style="repeat_password_error"
            ref="repeat_password_error"
          >
            <input
    ...
    <div id="password-was-updated-modal" v-else>
      ...
      <div class="recovery-label">Now you can return to the login page.</div>
      <blue-button id="go-to-login" @click.native="redirect_to_login"
        >Log in</blue-button
      >
    </div>
  </div>
...
export default {
  ...
  computed: {
    button_style() {
      ...
      if (
        this.password_is_fine &&
        this.repeat_password_is_fine &&
        this.check_length
      ) {
        return {
          "--box-shadow": "0 0 20px rgba(105, 106, 233, 0.2)",
    ...
    check_length() {
      return !(
        ...
        this.repeat_password.length < 8 ||
        this.code_from_input.length < 8
      );
    },
