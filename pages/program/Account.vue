  ...
  <div id="account-page">
    ...
    <transition name="opacity">
      <deactivation-confirmation
        v-show="isDeactivateConfirmation"
      ></deactivation-confirmation>
    </transition>
    <transition name="opacity">
    ...
    <div class="content">
      <div id="account-details-block" class="block">
        <div class="header">
          <div class="block-title">Account details</div>
        </div>
        <div class="body">
            ...
            <transition-group name="fade" mode="out-in" style="width: 100%">
              <div class="first" v-show="!this.email_is_editing" :key="'first'">
                <div class="text-content">
                  <div class="text-content-primary">Email</div>
                ...
                <blue-stroke-button
                  class="edit-button"
                  @click.native="email_is_editing = !email_is_editing"
                >
                  <edit-icon class="ico" />
                </blue-stroke-button>
              </div>
          ...
          <div id="currency" class="account-details-block">
            <transition-group name="fade" mode="out-in" style="width: 100%">
              <div
                class="first"
                v-show="!this.currency_is_editing"
                :key="'first-currency'"
              >
                <div class="text-content">
                  <div class="text-content-primary">Currency</div>
                  <div class="text-content-text">
                    {{ this.user_currency }}
                  </div>
                </div>
                <blue-stroke-button
                  class="edit-button"
                  @click.native="currency_is_editing = !currency_is_editing"
                >
                  <edit-icon class="ico" />
                </blue-stroke-button>
              </div>
          ...
          <div id="password" class="account-details-block">
            <div class="text-content">
              <div class="text-content-primary">Password</div>
              <div class="text-content-text">**********</div>
            </div>
            <blue-stroke-button
              class="edit-button"
              @click.native="isPasswordModal = true"
            >
              <edit-icon class="ico" />
            </blue-stroke-button>
          </div>
      ...
      <div id="export-data-block" class="block">
        ...
        <blue-button
          @click.native="isExportModal = true"
      ...
      <div id="account-actions-block" class="block">
        <div id="log-out">
          <div class="text-content">
            <div class="text-content-primary">Log out</div>
            <div class="text-content-text">
        ...
        <div id="deactivate-account">
          <div class="text-content">
            <div class="text-content-primary">Deactivate account</div>
            <div class="text-content-text">
          ...
          <div class="button-div">
            <red-stroke-button
              ...
              class="bttn"
              @click.native="isDeactivateConfirmation = true"
            >
              Deactivate
            </red-stroke-button>
          </div>
