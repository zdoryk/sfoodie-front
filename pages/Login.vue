    ...
    <div class="content">
      ...
      <div class="inputs">
        ...
        <input
          ...
          v-on:keyup.enter="authentificate"
        />
        ...
        <input
          ...
          v-on:keyup.enter="authentificate"
        />
        <nuxt-link id="forgot-password-link" to="/PasswordRecovery"
          ><p class="link-text">Forgot password?</p></nuxt-link
        >
      </div>
      <div class="footer">
        <blue-button
          ...
          :style="buttonStyle"
          id="login-button"
          @click.native="authentificate"
          >{{ buttonText }}</blue-button
        >
        <p>Don't have an account?</p>
        <nuxt-link id="sign-up-link" to="/SignUp"
          ><p class="link-text">Create new one!</p></nuxt-link
        >
      </div>
    </div>
  </div>
